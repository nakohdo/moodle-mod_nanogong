<?php  // $Id: locallib.php,v 4.1 2011/02/28 00:00:00 gibson,oz Exp $
...
?>
    ...
    <tr valign="top">
        ...
        <td align="left"><input type="text" id="score" name="score" size="7" maxsize="7" value="<?php p($nanogong_message->score) ?>" />
<?php
        if ($nanogong->maxscore) {
?>
            (<?php  print_string("nanogongmaxscore", "nanogong") ?>: <?php p($nanogong->maxscore) ?>)
<?php
        }
?>
        </td>
...
?>
    ...
    <div id="nanogong_container" style="position:absolute; top: -40px; left: -130px; z-index:1000">
